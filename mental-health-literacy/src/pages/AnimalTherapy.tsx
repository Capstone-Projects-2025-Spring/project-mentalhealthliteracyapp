        ...
        <div className="card-grid">
          ...
          >
            ...
            <div className="resource-meta">
              Read about animal assisted therapy, its uses, and benefits on
              Psychology Today.
            </div>
          </a>
          <a
          ...
          >
            ...
            <div className="resource-meta">
              Temple University Hospital’s animal assisted interaction program,
              featuring certified dogs and their handlers
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="section">
        ...
        <div className="card-grid">
          <div className="resource-card">
            ...
            <div className="resource-meta">
              To become a member of Temple Tails, call Guest Relations at{" "}
              <strong>215-707-5479</strong>.
            </div>
          </div>
        </div>
      </div>
