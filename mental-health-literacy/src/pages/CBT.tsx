    ...
    const steps: Step[] = [
        {
            ...
            content: "Here we provide information about said mental health resource. This link provides more details about Cognitive Behavioral Therapy.",
        },
        {
            target: "#cbt-phone-number",
            content: "Here we can provide helpful contact information such as phone numbers, emails, or social medias. This is the phone number for Temple Health.",
        },
        {
            target: "#cbt-schedule-appointment",
            content: "Here we can provide links to schedule appointments or find more information to do so. This link allows you to schedule an appointment with Temple Health.",
        },
        {
