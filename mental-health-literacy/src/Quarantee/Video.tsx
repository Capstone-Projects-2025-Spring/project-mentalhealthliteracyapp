...
function Video() {
  ...
  const [videos] = useState<Video[]>([
    ...
    },
    {
      ...
      description:
        "Join a group CBT therapy session and learn together. #GroupTherapy #CBT",
      likes: 3000,
      tags: [
    ...
    },
    {
      ...
      likes: 3000,
      tags: [{ label: "Mental Health", url: "/resources/mental-health" }],
    },
    {
      id: 8,
      ...
      description:
        "Join me for a therapeutic yoga session to boost your mental well-being. #YogaTherapy #Mindfulness",
      likes: 2100,
      tags: [
        { label: "Yoga", url: "yoga" },
